...
const packages = [
  ...
  },
  {
    ...
    features: ["IRC / ERC documentation", "Customs compliance support", "Import license processing", "End-to-end assistance", "Dedicated case handler"],
    icon: Shield,
    featured: true,
  },
  {
    ...
    features: ["Affidavit preparation", "Business agreements", "Notarization support", "Legal review", "Document filing"],
    icon: FileText,
    featured: false,
  },
  {
    ...
    sub: "Business Setup",
    price: "৳ 10,000",
    desc: "Help with trade license, VAT (BIN), and tax (TIN) registration for businesses.",
    features: ["Trade license registration", "VAT (BIN) registration", "TIN certificate", "Business setup guidance"],
    icon: Award,
    featured: false,
  },
  {
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {packages.map((pkg, i) => (
            <div
              key={i}
              className={`relative flex flex-col transition-all duration-300 border ${pkg.featured ? "bg-[#1B4FD8] border-[#1B4FD8] shadow-2xl" : "bg-white border-[#e5e7eb] hover:shadow-xl"}`}
