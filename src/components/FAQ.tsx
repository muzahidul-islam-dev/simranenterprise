  ...
  return (
    <div className="space-y-2">
      {faqs.map((faq, i) => (
        <div
          key={i}
          className={`border overflow-hidden transition-all duration-200 ${open === i ? "border-[#1B4FD8]" : "border-[#e5e7eb]"}`}
        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{ background: open === i ? "#1B4FD8" : "#f3f4f6", borderRadius: "6px" }}
            >
              {open === i
          ...
          {open === i && (
            <div className="px-6 pb-6 bg-white border-t border-[#e5e7eb]">
              <p
                className="pt-4"
                style={{ fontFamily: "var(--font-main)", fontSize: "14px", lineHeight: "1.85", color: "#4b5563" }}
              >
                {faq.a}
              </p>
            </div>
