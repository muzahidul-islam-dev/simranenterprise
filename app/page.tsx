...
export default function Home() {
  return (
    <div className="min-h-screen bg-white" style={F}>
      ...
      {/* HERO */}
      <section className="relative min-h-screen flex items-center overflow-hidden" data-theme="dark">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h1 className="text-white mb-7"
                style={{ fontFamily:"var(--font-main)", fontSize:"clamp(2.8rem,5vw,4.4rem)", fontWeight:800, lineHeight:1.08, letterSpacing:"-0.025em" }}>
                Expert Solutions<br/>
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="relative">
              <div style={{ borderRadius:"12px" }} className="overflow-hidden">
            ...
            {[
              ...
              <div key={i} className={`relative flex flex-col transition-all duration-300 border ${pkg.featured ? "bg-[#1B4FD8] border-[#1B4FD8] shadow-2xl" : "bg-white border-[#e5e7eb] hover:shadow-xl"}`} style={{ borderRadius:"12px" }}>
                ...
                <div className="p-8 flex flex-col flex-1">
                  ...
                  <Link href="/services"
                    className={`w-full flex items-center justify-center gap-2 py-[13px] text-[12px] font-bold tracking-[0.1em] uppercase transition-colors group ${pkg.featured ? "bg-white text-[#1B4FD8] hover:bg-[#eff6ff]" : "bg-transparent border border-[#e5e7eb] text-[#0d1b2a] hover:text-[#1B4FD8]"}`}
                    style={{ borderRadius:"12px" }}>
      ...
      <section className="py-24 px-6 bg-white overflow-hidden">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-6 mb-6">
            <div className="bg-[#1B4FD8] p-10 flex flex-col justify-between" data-theme="dark" style={{ borderRadius:"12px" }}>
              <div>
      ...
      <section className="py-24 px-6 bg-[#f8f9fa] overflow-hidden">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-[#1B4FD8] p-10 text-white" data-theme="dark" style={{ borderRadius:"12px" }}>
              <div className="w-14 h-14 bg-white/15 flex items-center justify-center mb-7" style={{ borderRadius:"12px" }}>
                <Award className="w-7 h-7 text-white"/>
              </div>
                ...
                <div className="relative h-[400px] overflow-hidden">
                  ...
                  <div className="absolute top-5 right-5 flex flex-col gap-2 opacity-0 group-hover:opacity-100 translate-x-4 group-hover:translate-x-0 transition-all duration-300">
                    {[["M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"]].map((d,j)=>(
                      <a key={j} href="#" className="w-9 h-9 bg-white/15 hover:bg-[#1B4FD8] border border-white/25 flex items-center justify-center transition-colors" style={{ borderRadius:"12px" }}>
                        <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24"><path d={d[0]}/></svg>
                      </a>
                    ))}
                  </div>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-[1400px] mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-14">
            ...
            <Link href="/blog" className="shrink-0 inline-flex items-center gap-2 border border-[#e5e7eb] text-[#0d1b2a] hover:text-[#1B4FD8] transition-colors px-6 py-3 text-[13px] font-bold tracking-[0.08em] uppercase group" style={{ borderRadius:"12px" }}>
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="grid lg:grid-cols-[1fr_2fr] gap-16 items-start">
            ...
            <div className="lg:sticky lg:top-32">
              ...
              <h2 className="mb-5" style={{ fontSize: "clamp(1.9rem,3vw,2.6rem)", fontWeight: 800, lineHeight: 1.12, color: "#0d1b2a", letterSpacing: "-0.02em" }}>
                What Our <span style={{ color: "#1B4FD8" }}>Clients Say</span>
              </h2>
              <p className="text-[#4b5563] text-[15px] leading-relaxed mb-8">
                Trusted by 5000+ businesses across Bangladesh. Here&apos;s what our clients have to say about working with us.
              </p>
              <div className="flex items-center gap-6 py-6 border-t border-b border-[#e5e7eb] mb-8">
                {[["5000+", "Happy Clients"], ["15+", "Years Experience"], ["100%", "Satisfaction"]].map(([n, l]) => (
                  <div key={l} className="text-center">
                    <div className="text-[1.6rem] font-black text-[#1B4FD8] leading-none">{n}</div>
                    <div className="text-[11px] text-[#9ca3af] font-semibold uppercase tracking-wide mt-1">{l}</div>
                  </div>
                ))}
              </div>
              <Link
      ...
      {/* FOOTER */}
      <footer className="bg-[#060e1a] text-white/40" data-theme="dark" style={{ fontFamily: "var(--font-main)" }}>

        {/* Top CTA band */}
        <div className="bg-[#1B4FD8] py-14 px-6" data-theme="dark">
          ...
          <div className="max-w-[1400px] mx-auto">
            <div className="grid lg:grid-cols-[2fr_1fr_1fr_1fr_1.4fr] gap-10 mb-14">
              ...
              <div>
                ...
                <p className="text-[14px] leading-[1.85] mb-6 max-w-xs">
                ...
                <div className="space-y-2.5 text-[13px]">
                  ...
                  <a href="mailto:hello@simranenterprise.com" className="flex items-center gap-3 hover:text-white transition-colors">
                    ...
                    <span>hello@simranenterprise.com</span>
                  </a>
                </div>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3 text-[14px]">
                  {[["Home", "/"], ["About", "/about"], ["Services", "/services"], ["Our Plans", "/plan"], ["Blog", "/blog"], ["Contact", "/contact"]].map(([label, href]) => (
                    <li key={label}>
                      <Link href={href} className="hover:text-[#F5A623] hover:pl-1 transition-all duration-200">
                        {label}
                      </Link>
                    </li>
                  ))}
              ...
              <div>
                ...
                <ul className="space-y-3 text-[14px]">
                  {["IRC / ERC Registration", "Trade License", "BIN / TIN Registration", "NOC & Approvals", "Legal Documentation", "DOF / DLS Consultancy"].map((s) => (
                    <li key={s}>
                      <Link href="/services" className="hover:text-[#F5A623] hover:pl-1 transition-all duration-200">
                        {s}
                      </Link>
                    </li>
                  ))}
              ...
              <div>
                ...
                <ul className="space-y-3 text-[14px]">
                  {["Privacy Policy", "Terms of Service", "Cookie Policy", "Portfolio", "Careers"].map((s) => (
                    <li key={s}>
                      <Link href="#" className="hover:text-[#F5A623] hover:pl-1 transition-all duration-200">
                        {s}
                      </Link>
                    </li>
                  ))}
              ...
              <div>
                ...
                <p className="text-[14px] leading-relaxed mb-5">
                  Stay updated with the latest news, trade alerts and service updates.
                </p>
                <div className="flex">
                  <input
                    type="email"
            ...
            <div className="pt-8 border-t border-white/[0.07] flex flex-col sm:flex-row justify-between items-center gap-4 text-[13px]">
              <p>&copy; 2026 Simran Enterprise. All rights reserved.</p>
